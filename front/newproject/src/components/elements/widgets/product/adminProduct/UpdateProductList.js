    ...
    return(
        <div className="cart-main-area pt-90 pb-100">
            <div className="container">
                <h3 className="cart-page-title">상품 리스트</h3>
                <div className="row">
                            ...
                            <table>
                                ...
                                <tbody>
                                    {currentPosts && currentPosts.map((order, idx) => (
                                            ...
                                            <tr key={idx}>
                                                <td className="product-thumbnail">{order.productName}</td>
                                                ...
                                                <td className="product-name text-center"><span className="amount">{order.detail}</span></td>
                                                <td className="product-name text-center"><span>{order.createdAt}</span></td>
                                                <td className="product-wishlist-cart"><Link to={`/update/${order.productId}`}>Update</Link></td>
                                                <td className="product-remove"><button onClick={()=>handleDelete(order.productId)}><i className="fa fa-times"></i></button></td>
                                            </tr>
